...
<body>
    ...
    <div class="container">
        ...
        <main class="container my-5 flex-grow-1">
            <div class="row">
                <div class="col-md-4">
                    <img src="<?php echo htmlspecialchars($row['cover_image']); ?>" class="img-fluid rounded" alt="<?php echo htmlspecialchars($row['title']); ?>">
                </div>
                <div class="col-md-8">
                    ...
                    <a href="<?php echo htmlspecialchars($row['book_file']); ?>" class="btn btn-primary">Читать онлайн</a>
                    <a href="<?php echo htmlspecialchars($row['book_file']); ?>" class="btn btn-secondary" download>Скачать</a>
                </div>
            </div>
            <div class="mt-4">
